...
BEGIN TRY
    ...
    FROM '/var/opt/mssql/datasets/sp500_data_part1.csv'
    WITH (
        FIRSTROW = 2,
        FIELDTERMINATOR = ',',
        ROWTERMINATOR = '0x0a'
...
BEGIN TRY
    BULK INSERT SP500_data_Raw
    FROM '/var/opt/mssql/datasets/sp500_data_part2.csv'
    WITH (
        FIRSTROW = 2,
        FIELDTERMINATOR = ',',
        ROWTERMINATOR = '0x0a'
...
BEGIN TRY
    BULK INSERT CSI500
    FROM '/var/opt/mssql/datasets/CSI500-part-1.csv'
    WITH (
        FIRSTROW = 2,
        FIELDTERMINATOR = ',',
        ROWTERMINATOR = '0x0a',
...
BEGIN TRY
    BULK INSERT CSI500
    FROM '/var/opt/mssql/datasets/CSI500-part-2.csv'
    WITH (
        FIRSTROW = 2,
        FIELDTERMINATOR = ',',
        ROWTERMINATOR = '0x0a',
